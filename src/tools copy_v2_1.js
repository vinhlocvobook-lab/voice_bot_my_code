    ...
    send_message({
        ...
        item: {
            ...
            output: JSON.stringify({
                ...
                message: `Dạ, Quý khách vui lòng đọc mã danh bộ, 11 chữ số, đọc liên tục, liền mạch, không ngắt quãng giúp em ạ !`
            }),
        }
    })
    send_message({
        type: "response.create",
        response: { instructions: `Đọc chính xác câu sau : "Dạ, Quý khách vui lòng đọc mã danh bộ, 11 chữ số, đọc liên tục, liền mạch, không ngắt quãng giúp em ạ ! "` }
    })
...
function sdb_doc_mdb_sai(function_event, send_message) {
    send_message({
        ...
        item: {
            ...
            output: JSON.stringify({
                success: false,
                error: "Khách xác nhận mã danh bộ trước đó bị sai",
    ...
    send_message({
        type: "response.create",
        response: { instructions: `Đọc câu chính xác câu và không thêm bất cứ lời dẫn dắt nào khác : "Dạ, em xin lỗi! Quý khách vui lòng đọc lại mã danh bộ, 11 chữ số, đọc liên tục, liền mạch, không ngắt quãng giúp em ạ ! "` }
    })
    ...
    send_message({
        ...
        item: {
            ...
            output: JSON.stringify({
                success: false,
                ma_danh_bo: mdb_gpt,
                error: "mã danh bộ chưa đúng",
                message: "Cần khách hàng đọc lại"
            }),
        }
    })
    send_message({
        type: "response.create",
        response: { instructions: `Đọc câu chính xác câu và không thêm bất cứ lời dẫn dắt nào khác : "Dạ, em nghe chưa được, Quý khách vui lòng đọc lại mã danh bộ, 11 chữ số, đọc liên tục, liền mạch, không ngắt quảng giúp em một lần nữa nhé!"` }
    })
